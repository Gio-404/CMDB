...
class Asset(models.Model):
    ...
    business_unit = models.ForeignKey('BusinessUnit', null=True, verbose_name='所属业务线',
...
class Server(models.Model):
    ...
    hosted_on = models.ForeignKey('self', related_name='hosted_on_server',
                                  blank=True, null=True, verbose_name="宿主机", on_delete=models.CASCADE)
...
class NetworkDevice(models.Model):
    ...
    intranet_up = models.GenericIPAddressField(blank=True, null=True, verbose_name="内网IP")
...
class EventLog(models.Model):
    ...
    name = models.CharField('时间名称', max_length=128)
    event_type_choice = (
        (0, '其他'),
        (1, '硬件变更'),
        (2, '新增配件'),
